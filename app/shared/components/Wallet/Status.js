...
class WalletStatus extends Component<Props> {
  ...
  componentDidMount = () => {
    ...
    actions.getTable('enumivo', settings.account, 'delband');
  }
  ...
  render() {
    ...
    const enuAccount = new ENUAccount(account, balance, delegations, connection.chainSymbol);
