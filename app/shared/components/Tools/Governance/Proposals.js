    ...
    return (
      <Segment basic>
        <Header>
          ...
          <Header.Subheader>
            This feature is a preview release of the upcoming Referendum system being implemented into the ENU ecosystem.
          </Header.Subheader>
        </Header>
        <Message
          content={(
