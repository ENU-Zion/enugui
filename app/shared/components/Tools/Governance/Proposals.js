    ...
    return (
      <Segment basic>
        <Header>
          ...
          <Header.Subheader>
            This feature is a preview release of the upcoming Referendum system being implemented into the Enumivo ecosystem.
          </Header.Subheader>
        </Header>
        <Message
          content={(
            <React.Fragment>
              <p>
                The Referendum system is a smart contract that allows Enumivo stakeholders to directly be involved in the governance of the Enumivo blockchain. When a proposal is entered into the referendum contract, there will be a period of time where all accounts staking ENU will be allowed to vote in yes/no on the matters presented in a stake weighted system.
              </p>
              <p>
