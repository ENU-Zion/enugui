...
*
* @example
* import Enu from "@ledgerhq/hw-app-enu";
* const enu = new Enu(transport)
*/
export default class Enu {
  transport: Transport<*>;
  ...
  /**
  * get Enumivo public key for a given BIP 32 path.
  * @param path a path in BIP 32 format
  * @option boolDisplay optionally enable or not the display
  * @option boolChaincode optionally enable or not the chaincode request
  * @return an object with a publicKey, address and (optionally) chainCode
  * @example
  * enu.getPublicKey("44'/194'/0'/0'/0").then(o => o.address)
  */
  getPublicKey(
    path: string,
    boolDisplay?: boolean,
